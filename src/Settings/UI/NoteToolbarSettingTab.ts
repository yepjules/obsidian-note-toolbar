...
import { displayAppToolbarSettings as displayAppToolbarSettingsSection } from './Sections/AppToolbarSettingsSection';
import { displayCopyAsCalloutSettings as displayCopyAsCalloutSettingsSection } from './Sections/CopyAsCalloutSection';
import { displayRules as displayRulesSection } from './Sections/DisplayRulesSection';
import { displayFileTypeSettings as displayFileTypeSettingsSection } from './Sections/FileTypeSettingsSection';
import { displayNavbarSettings as displayNavbarSettingsSection } from './Sections/NavbarSettingsSection';
import { displayOtherSettings as displayOtherSettingsSection } from './Sections/OtherSettingsSection';
import { displayToolbarList as displayToolbarListSection } from './Sections/ToolbarListSection';
import type { SettingsTabState } from './Sections/types';
...
export default class NoteToolbarSettingTab extends PluginSettingTab {
	...
	public display(focusSelector?: string, scrollToFocus: boolean = false): void {
		...
		displayToolbarListSection(state, containerEl);

		// display rules
		displayRulesSection(state, containerEl);
		// this.ruleUi.displayRules(containerEl);

		displayNavbarSettingsSection(state, containerEl);
		displayAppToolbarSettingsSection(state, containerEl);
		displayFileTypeSettingsSection(state, containerEl);

		// other global settings
		displayCopyAsCalloutSettingsSection(state, containerEl);
		displayOtherSettingsSection(state, containerEl);
	...
	displayFocusScroll(focusSelector: string | undefined, scrollToFocus: boolean) {
		...
		// on desktop, if search is enabled (>4 toolbars), focus on search field by default
